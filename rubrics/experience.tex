	...
	\iflanguage{french}{
		...
		\begin{itemize}
			\item \textbf{Art Council President}
			      \begin{itemize}
				      \item Revitalized campus arts engagement through 3+ monthly events (concerts, exhibitions) and directed the annual gala for 100+ artists.
				      \item Launched workshops (music, dance, theater), doubling participation in one year.
			      \end{itemize}
			\item \textbf{Sports Coordinator, Cartel des Mines 2022}
			      \begin{itemize}
				      \item Managed logistics for a 4-day national competition (1,800+ participants, 14 sports, \$160K budget), achieving high participant satisfaction via streamlined scheduling.
			      \end{itemize}

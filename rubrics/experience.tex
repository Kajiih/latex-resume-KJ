...
\cventry{
	...
	\iflanguage{french}{
		\begin{itemize}
			...
			\item Formation de 15+ chercheurs au framework de machine learning JAX\@.
			\item Assistant d'enseignement en \emph{Mathématiques Discrètes} et \emph{Modèles Graphiques Probabilistes} pour 150 étudiants de 2\ts{nd} cycle.

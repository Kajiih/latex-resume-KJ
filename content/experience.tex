...
\bulletItem{
    \IfLanguageName{french}{
        ...
        Implémentation complète d'un modèle probabiliste d'extraction de compétences en JAX/Flax, réduisant les coûts d'entraînement par un facteur de 3.
        Facilitée l'adoption du framework de machine learning JAX au sein du laboratoire en formant et accompagnant d'autres chercheurs dans son utilisation, atteignant environ 25\% d'adoption en un an.
    }{
...
\bulletItem{
    \IfLanguageName{french}{
        ...
        Déploiement de conteneurs Docker pour exécuter des simulations Unity sur un cluster sans interface graphique, optimisant l'entraînement des agents de RL\@.
